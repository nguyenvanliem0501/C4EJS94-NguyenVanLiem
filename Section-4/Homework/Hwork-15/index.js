...
console.log("1. Get all the jobs hit");
console.log(jobData);
console.log("2. Get the first job hit");
console.log(jobData.hits[0]);
console.log("3. Get jobTitle of the first job");
console.log(jobData.hits[0].jobTitle);
console.log("4. Get the benefits of the first job hit");
console.log(jobData.hits[0].benefits);
console.log("5. Log out first job hit benefit values: ");
...
console.log("6. Log out jobTitle and benefitValue of all job hits")
...
console.log("7. Log out jobTitle, locations, skills, jobSalary of all job hits");
for (let i = 0; i < jobData.hits.length; i++) {
    console.log(jobData.hits[i].jobTitle);
    console.log("Location:");
    for (let a = 0; a < jobData.hits[i].locations.length; a++) {
