...
console.log(a);
console.log("The outermost layer data type is the object");
console.log("The hits property is where the job results are stored. Hits is array and it stores object");
console.log("In each hit of hits, we can find all of these in object benifits stored by hits ");
