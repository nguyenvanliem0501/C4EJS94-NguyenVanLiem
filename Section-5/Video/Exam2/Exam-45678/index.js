...
console.log("4. Get jobTitle of the first job");
console.log(jobData.hits[0].jobTitle);
console.log("---------------------------------");
console.log("5. Get the benefits of the first job hit");
console.log(jobData.hits[0].benefits);
console.log("---------------------------------");
console.log("6. Log out first job hit benefit values: ");
...
console.log("---------------------------------");
console.log("7. Log out jobTitle and benefitValue of all job hits")
...
console.log("---------------------------------");
console.log("8. Log out jobTitle, locations, skills, jobSalary of all job hits");
for (let i = 0; i < jobData.hits.length; i++) {
    console.log(jobData.hits[i].jobTitle);
